...
import icy.spidey.messenger.connect.Activities.ChatUiActivity;
import icy.spidey.messenger.connect.R;
import icy.spidey.messenger.connect.Models.User;
import icy.spidey.messenger.connect.databinding.RowConversationBinding;
    ...
    public void onBindViewHolder(@NonNull UsersViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent i = new Intent(context, ChatUiActivity.class);
