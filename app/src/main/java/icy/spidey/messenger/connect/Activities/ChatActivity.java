...
import icy.spidey.messenger.connect.Adapters.UsersAdapter;
import icy.spidey.messenger.connect.databinding.ActivityChatBinding;
...
public class ChatActivity extends AppCompatActivity {
  ...
  @Override
    ...
    protected void onPause() {
        ...
        String currentId = FirebaseAuth.getInstance().getUid();
        Date date = new Date();
        database.getReference().child("presence").child(currentId).setValue("Last seen " + date);
    }
